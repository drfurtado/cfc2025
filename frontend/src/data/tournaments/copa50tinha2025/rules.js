/**
 * Copa 50tinha 2025 Tournament Rules
 * Structured data based on the tournament regulations
 */

export const rulesData = {
  title: "Regulamento Específico - Copa 50TINHA - Temporada 2025",
  sections: [
    {
      title: "Objetivo",
      content: "Promover o intercâmbio e o congraçamento entre atletas, clubes e entidades do futebol de pelada de Curitiba e Região Metropolitana."
    },
    {
      title: "Participantes",
      content: "Sete equipes:",
      list: [
        "Classe",
        "Cometa",
      ...
      subsections: [
        {
          ...
          content: "Critérios de desempate:",
          numberedList: [
            "Menor número de WO",
            "Confronto direto",
        ...
        {
          title: "Terceira Fase (Final)",
          content: "Jogo único. Empate leva à disputa de pênaltis."
        }
      ]
    },
    {
